...
SYSTEM = (
    ...
    "- If the user asks to index/read/ingest/load ALL files in a folder, or many PDFs"
    "  from a folder, call `index_folder` directly. Do NOT call `list_dir` first."
    "  Do NOT call `read_file` for each file. `index_folder` is the batch tool for"
