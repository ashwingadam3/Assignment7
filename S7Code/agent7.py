...
def main() -> None:
    query = " ".join(sys.argv[1:]) or """Across the papers I have indexed, can you tell me how can I want to build an enterprise AI assistant that can search documents, use tools, and remember previous interactions."""
