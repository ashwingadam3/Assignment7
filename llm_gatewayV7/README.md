...
Recommended k strategy for indexing:

- 500–1000 tokens per k (≈2000–4000 chars) for retrieval quality
- overlap 50–100 tokens between adjacent ks
- embed each k separately, store with `(doc_id, chunk_id)` metadata
